...
public class leverthehuge extends MainActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lev = FirebaseDatabase.getInstance().getReference();
        lev.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                dataSnapshot = dataSnapshot.child("lever").child("prize");
