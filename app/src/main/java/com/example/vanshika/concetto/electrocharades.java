...
public class electrocharades extends MainActivity{
    TextView tl;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.replaceContentLayout(R.layout.electrocharades, R.id.content_main_linear_layout);
        ...
        pr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                prizes = new AlertDialog.Builder(electrocharades.this);
                prizes.setMessage(R.string.electrocharadesPrize);
