...
public class aquarise extends MainActivity {
    TextView tl;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.replaceContentLayout(R.layout.aquarise, R.id.content_main_linear_layout);
        ...
        tru.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                dataSnapshot = dataSnapshot.child("aq").child("prize");
        ...
        pr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                prizes = new AlertDialog.Builder(aquarise.this);
                prizes.setMessage(p);
