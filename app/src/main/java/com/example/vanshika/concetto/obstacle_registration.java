                ...
                if(connected) {
                    ...
                    if (name.isEmpty() == true || mem1.isEmpty() == true || mem2.isEmpty() == true || mem3.isEmpty() == true || mem4.isEmpty() == true || email.isEmpty() == true) {
                        ...
                        obs.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    registration_team reg = snapshot.getValue(registration_team.class);
                                    String p = reg.getTeamname();
                                  //  boolean pv = p.equals(name);
                                    if (p == name) {
                                        Log.e(TAG,"here");
                                        nm.setError("This team name is already existed");
                                        focusView[0] = nm;
                                        uv =false;
                                        Toast.makeText(obstacle_registration.this, "THIS TEAM NAME IS ALREADY EXISTS ",
                        ...
                        if(uv){
                            ...
                            registration_team regs = new registration_team(name, mem1, mem2, mem3, mem4, email);
                            obs.child(id).setValue(regs);
