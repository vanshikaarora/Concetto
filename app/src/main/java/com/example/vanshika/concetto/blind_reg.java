                ...
                if(connected) {
                  ...
                  /*  if(TextUtils.isEmpty(mem4)){
                    ...
                    if (name.isEmpty() == true || mem1.isEmpty() == true || mem2.isEmpty() == true || mem3.isEmpty() == true) {
                        ...
                        obs.child("blinddate").child(id).child("name").setValue(name);
                        obs.child("blinddate").child(id).child("email").setValue(mem1);
                    ...
                    Toast.makeText(blind_reg.this, "INTERNET CONNECTION IS NOT AVAILABLE",
                            Toast.LENGTH_LONG).show();
