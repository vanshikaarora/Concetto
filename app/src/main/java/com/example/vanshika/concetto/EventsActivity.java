...
public class EventsActivity extends MainActivity {
    ...
    List<GuestLecture> guestLectures;
...
//creating recyclerview adapter
            ...
            recyclerView.setAdapter(adapter);
                ...
                guestLectures.add(new GuestLecture("guest_lecture_1","lecturer-name1","android.resource://com.example.vanshika.concetto/" + R.drawable.concetto_white,"7:434am"));
                guestLectures.add(new GuestLecture("guest_lecture_1","lecturer-name1","android.resource://com.example.vanshika.concetto/" + R.drawable.concetto_white,"7:434am"));
                guestLectures.add(new GuestLecture("guest_lecture_1","lecturer-name1","android.resource://com.example.vanshika.concetto/" + R.drawable.concetto_white,"7:434am"));
                guestLectures.add(new GuestLecture("guest_lecture_1","lecturer-name1","android.resource://com.example.vanshika.concetto/" + R.drawable.concetto_white,"7:434am"));
