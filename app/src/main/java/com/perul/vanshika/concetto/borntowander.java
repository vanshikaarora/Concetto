...
public class borntowander extends MainActivity {
    TextView tl;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.replaceContentLayout(R.layout.borntowander, R.id.content_main_linear_layout);
        ...
        tru.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                dataSnapshot = dataSnapshot.child("born").child("prize");
        ...
        ab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                about = new AlertDialog.Builder(borntowander.this);
        ...
        jud.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                judging = new AlertDialog.Builder(borntowander.this);
        ...
        ru.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rules = new AlertDialog.Builder(borntowander.this);
        ...
        pr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                prizes = new AlertDialog.Builder(borntowander.this);
                prizes.setMessage(p);
        ...
        co.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                contacts = new AlertDialog.Builder(borntowander.this);
