...
public class munreg extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (connected) {
                    ...
                    if (TextUtils.isEmpty(name2)) {
                        nm2.setError("field is required");
                        focusView[0] = nm2;
                  ...
                  /*  if(TextUtils.isEmpty(mem4)){
                    ...
                    if (name.isEmpty() == true || mem1.isEmpty() == true || mem2.isEmpty() == true || mem3.isEmpty() == true || name2.isEmpty()) {

                    } else {
                        String id = obs.push().getKey();
                        obs.child("mun").child(id).child("name").setValue(name);
                        obs.child("mun").child(id).child("name2").setValue(name2);
                        obs.child("mun").child(id).child("email").setValue(mem1);
                    ...
                    Toast.makeText(munreg.this, "INTERNET CONNECTION IS NOT AVAILABLE",
                            Toast.LENGTH_LONG).show();
