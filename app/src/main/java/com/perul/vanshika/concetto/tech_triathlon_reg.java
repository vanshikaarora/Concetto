...
public class tech_triathlon_reg extends AppCompatActivity {
                ...
                if(connected) {
                  ...
                  /*  if(TextUtils.isEmpty(mem4)){
                    ...
                    if (name.isEmpty() == true || mem1.isEmpty() == true || mem2.isEmpty() == true || mem3.isEmpty() == true) {
                        ...
                        obs.child("triathlon").child(id).child("name").setValue(name);
                        obs.child("triathlon").child(id).child("email").setValue(mem1);
                    ...
                    Toast.makeText(tech_triathlon_reg.this, "INTERNET CONNECTION IS NOT AVAILABLE",
                            Toast.LENGTH_LONG).show();
