...
public class fifa_reg extends AppCompatActivity {
                ...
                if(connected) {
                  ...
                  /*  if(TextUtils.isEmpty(mem4)){
                    ...
                    if (name.isEmpty() == true || mem1.isEmpty() == true || mem2.isEmpty() == true || mem3.isEmpty() == true) {
                        ...
                        obs.child("memewar").child(id).child("name").setValue(name);
                        obs.child("memewar").child(id).child("email").setValue(mem1);
                    ...
                    Toast.makeText(fifa_reg.this, "INTERNET CONNECTION IS NOT AVAILABLE",
                            Toast.LENGTH_LONG).show();
